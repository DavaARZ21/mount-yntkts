if game.PlaceId == 92811427244720 then
    ...
    Main:CreateParagraph({
        ...
        Content = "Sebelum Auto Summit wajib reset ke basecamp (nanti kalian bakalan di teleport ke checkpoint 17, kalo udah tp gak balik ke cp 1 langsung bisa mulai autofarmnya guys). Auto Summit akan otomatis farm dari CP1 sampai Summit, lalu kembali ke basecamp  untuk reset. Script akan loop terus sampai toggle dimatikan."
    })
    ...
    Tools:CreateParagraph({
        Title = "Info :",
        Content = "Teleport ke basecamp akan mereset checkpoint anda. Teleport to Basecamp akan men-teleport kalian ke Checkpoint 17, jika kalian tidak diteleport balik ke Checkpoint 1 kalian boleh langsung mulai Autofarm."
    })
    ...
    Tools:CreateButton({
        ...
        Callback = function()
            ...
            Rayfield:Notify({
                Title = "Teleport",
                Content = "Kembali ke basecamp (CP 17)",
                Duration = 3
            })
        end
    })
    ...
    -- Teleport Tool Section (Add this after the Fly section in Tools Tab)
...
Tools:CreateButton({
    ...
    Callback = function()
        ...
        TpTool.Activated:Connect(function()
            ...
            -- Mobile and PC compatible method
            local Mouse = lp:GetMouse()
            local targetPosition = nil
            
            if UserInputService.TouchEnabled then
                -- Mobile: Use camera raycast for better touch support
                local camera = workspace.CurrentCamera
